...
export const TIME_THEMES: Record<TimeThemeId, TimeThemeConfig> = {
  ...
  sunset: {
    ...
    bgImage: 'bg4white.png',
    isDarkBase: false,
    overlayGradient: 'linear-gradient(135deg, rgba(255, 140, 60, 0.15) 0%, rgba(168, 85, 247, 0.08) 100%)',
    scrimGradient: 'from-amber-50/95 via-white/85 to-transparent dark:from-[#041F3B]/95 dark:via-[#041F3B]/85 dark:to-transparent',
    titleGeGradient: 'linear-gradient(135deg, #022054 0%, #0849A3 100%)',
    titleVisionGradient: 'linear-gradient(135deg, #0849A3 0%, #E86198 50%, #05B386 100%)',
    subheadColor: 'text-slate-900 dark:text-white',
    subtitleColor: 'text-slate-700 dark:text-slate-200',
    taglineTextEn: 'SPATIAL INTELLIGENCE FOR A SMARTER TOMORROW',
    taglineTextAr: 'الذكاء المكاني لغدٍ أكثر ذكاءً',
    badgeStyle: 'bg-gradient-to-r from-orange-500/20 to-purple-600/20 text-amber-900 border-amber-300/80 shadow-orange-500/10',
  ...
  evening: {
    ...
    icon: '🌆',
    bgImage: 'bg4dark(3).png',
    isDarkBase: true,
    overlayGradient: 'none',
    scrimGradient: 'from-[#041F3B]/90 via-[#041F3B]/45 to-transparent',
    ...
    subheadColor: 'text-white drop-shadow-[0_2px_4px_rgba(0,0,0,0.9)]',
    subtitleColor: 'text-slate-100 drop-shadow-[0_1px_3px_rgba(0,0,0,0.9)]',
    taglineTextEn: 'SPATIAL INTELLIGENCE FOR A SMARTER TOMORROW',
    taglineTextAr: 'الذكاء المكاني لغدٍ أكثر ذكاءً',
